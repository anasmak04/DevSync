        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/user/dashboard">
                    ...
                    <span class="nav-link-text text-dark ms-1">My Tasks</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" style="background-color: #5E72E4;">
                    ...
                    <span class="nav-link-text text-white ms-1">Assigned Tasks</span>
                </a>
            </li>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-start">
                                                <div class="d-flex align-items-center">
                                                    <img src="${pageContext.request.contextPath}/${task.manager.profile}"
                                                         class="avatar avatar-sm me-2 border-radius-2xl"
                                                         alt="user"
                                                         style="object-fit: cover; width: 40px; height: 40px;">
                                                    <div class="d-flex flex-column align-items-start ms-2">
                                                        <span class="text-secondary text-xs font-weight-bold">${task.manager.username}</span>
                                                        <span class="text-secondary text-xs">-----</span>
                                                    </div>
                                                </div>
                                            </td>
